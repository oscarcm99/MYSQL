...
ALTER TABLE PERSONAJE ADD CONSTRAINT FOREIGN KEY (codigo_ACTOR) REFERENCES ACTOR(codigo) ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE PERSONAJE DROP FOREIGN KEY PERSONAJE_ibfk_2;
ALTER TABLE PERSONAJE ADD CONSTRAINT FOREIGN KEY (codigoSuperior_PERSONAJE) REFERENCES PERSONAJE(codigo) ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE PERSONAJEPELICULA DROP FOREIGN KEY PERSONAJEPELICULA_ibfk_1;
ALTER TABLE PERSONAJEPELICULA ADD CONSTRAINT FOREIGN KEY (codigo_PERSONAJE) REFERENCES PERSONAJE(codigo) ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE PERSONAJEPELICULA DROP FOREIGN KEY PERSONAJEPELICULA_ibfk_2;
ALTER TABLE PERSONAJEPELICULA ADD CONSTRAINT FOREIGN KEY (codigo_PELICULA) REFERENCES PELICULA(codigo) ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE VISITA DROP FOREIGN KEY VISITA_ibfk_1;
ALTER TABLE VISITA ADD CONSTRAINT FOREIGN KEY (codigo_NAVE) REFERENCES NAVE(codigo) ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE VISITA DROP FOREIGN KEY VISITA_ibfk_2;
ALTER TABLE VISITA ADD CONSTRAINT FOREIGN KEY (codigo_PLANETA) REFERENCES PLANETA(codigo) ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE VISITA DROP FOREIGN KEY VISITA_ibfk_3;
ALTER TABLE VISITA ADD CONSTRAINT FOREIGN KEY (codigo_PELICULA) REFERENCES PELICULA(codigo) ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE PERSONAJE DROP FOREIGN KEY PERSONAJE_ibfk_4;
ALTER TABLE PERSONAJE DROP codigoSuperior_PERSONAJE;
ALTER TABLE PERSONAJE ADD lado_Fuerza SET('jedi','sith');
